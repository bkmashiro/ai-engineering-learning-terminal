...
export const roadmapNodes: RoadmapNode[] = [
  ...
  {
    id: 'cache-reuse-consistency',
    title: '缓存工程：复用、失效与一致性',
    summary: '用工作集、完整缓存身份、并发Fill、失效与安全指标验证缓存是否真正节省工作且不服务旧值、越权值或错误答案。',
    stage: 'software-systems',
    order: 4,
    prerequisites: ['data-reliability'],
    outcomes: ['用Break-even与容量—命中曲线判断收益', '设计Generation、权限、Lease与Fencing边界', '区分Exact、Prefix与Semantic复用风险'],
    artifact: '带固定Manifest、策略对比、故障注入和Evidence报告的确定性缓存Simulator',
    directions: ['ai-backend-reliability', 'llm-search-retrieval', 'edge-inference'],
    href: '/foundations/software-systems/cache-reuse-consistency/',
    status: 'available',
  },
  {
    ...
    stage: 'software-systems',
    order: 5,
    prerequisites: ['cache-reuse-consistency'],
  ...
  },
  {
    ...
    stage: 'llm-applications',
    order: 8,
    prerequisites: ['llm-foundations', 'network-streaming', 'cache-reuse-consistency'],
